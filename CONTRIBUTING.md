# VoltEngine Milestones

## Phase 1: Dataset & Forward Pass
- [x] Create the XOR input and target dataset arrays.
- [x] Set up hidden layer variables.
- [x] Code the Loss Engine to see how wrong the AI is.
