...
std::string BPETokenizer::decode(const std::vector<int>& input_ids, std::map<int, std::string>& inverse_map) {
...
std::vector<int> BPETokenizer::encoder(const std::string& text, std::map<std::string, int>& vocab_map) {
